...
PICO-8 runs at BLANK frames per second (FPS)

In programming, the equal sign means BLANK ___it does not mean___ equal to.

If you want to print the contents of a variable, do not wrap it in BLANK marks.